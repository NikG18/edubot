...
def load_tutors():
    if os.path.exists(DATA_FILE):
        try:
            ...
            data = {}
        # Если данные пусты или не словарь – перезаписываем начальными
...
# ==================== ОСТАЛЬНОЙ КОД (весь ваш, без изменений) ====================
# ... (весь остальной код, который был ранее, начиная с get_all_subjects и до конца)
