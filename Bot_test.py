...
async def show_kolebaev_info(call: CallbackQuery):
    await call.message.edit_text(
        "Приветствую! Меня зовут Колебаев Никита Дмитриевич, я студент 4-ого курса МФТИ. Обучаюсь на бюджете по программе «Геокосмические науки и технологии». Имею опыт преподавания физики и математики для школьников: личное репетиторство и ЗФТШ (заочная физико-техническая школа при МФТИ). Окончил школу с золотой медалью, имею фундаментальные знания в области математики, физики и информатики (в том числе программирование на языках Python/C++). ЕГЭ сдал в 2023 году на следующие баллы: физика – 95, информатика – 90. Со средней школы увлекаюсь робототехникой и ракетостроением. По этим направлениям участвовал в соревнованиях всероссийского масштаба, в которых занимал в том числе призерские места. В институте продолжаю развиваться в данных направлениях и побеждать в вузовских состязаниях. Умею доступно спокойно и основательно объяснить материал любой сложности. Если испытываете трудности в понимании физики, математики и информатики или у Вас есть желание лучше прокачаться в этих дисциплинах, с радостью готов помочь Вам! Первое пробное занятие 30 минут бесплатно.\n\n"
        "Хотите записаться на пробное занятие?",
        reply_markup=InlineKeyboardMarkup(inline_keyboard=[
            [InlineKeyboardButton(text="🔙 Назад к списку", callback_data="back_to_tutors")]
        ])
